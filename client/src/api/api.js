...
export const updateUser = (user, id) => axios({
  url: `${API_BASE_URL}users/${id}`, method: 'POST', headers: { 'x-auth-token': getToken() }, data: user,
});
export const deleteUser = (id) => axios({ url: `${API_BASE_URL}users/${id}`, method: 'DELETE', headers: { 'x-auth-token': getToken() } });
export const loginUser = (data) => axios({ url: `${API_BASE_URL}users/login`, method: 'POST', data });

export const addToCart = (id) => axios({ url: `${API_BASE_URL}users/cart/${id}`, method: 'POST', headers: { 'x-auth-token': getToken() } });
export const updateCart = (amount, id) => axios({
  url: `${API_BASE_URL}users/cart/update/${id}`, method: 'POST', headers: { 'x-auth-token': getToken() }, data: amount,
});
...
export const addProduct = (product) => axios({
  url: `${API_BASE_URL}products`, method: 'POST', headers: { 'x-auth-token': getToken() }, data: product,
});
export const updateProduct = (product, id) => axios({
  url: `${API_BASE_URL}products/${id}`, method: 'POST', headers: { 'x-auth-token': getToken() }, data: product,
});
...
export const addCategory = (category) => axios({
  url: `${API_BASE_URL}categories/`, method: 'POST', headers: { 'x-auth-token': getToken() }, data: category,
});
export const updateCategory = (category, id) => axios({
  url: `${API_BASE_URL}categories/${id}`, method: 'POST', headers: { 'x-auth-token': getToken() }, data: category,
});
...
export const addOrder = (order) => axios({
  url: `${API_BASE_URL}orders`, method: 'POST', headers: { 'x-auth-token': getToken() }, data: order,
});
export const updateOrder = (order, id) => axios({
  url: `${API_BASE_URL}orders/${id}`, method: 'POST', headers: { 'x-auth-token': getToken() }, data: order,
});
